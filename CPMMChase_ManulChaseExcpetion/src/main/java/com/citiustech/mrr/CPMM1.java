...
public class CPMM1 implements java.io.Serializable {
	...
	@javax.persistence.Column(name = "ADDR_ZIPCD")
	...
	public void setDenominatorQualifyingEventDate(
			Date denominatorQualifyingEventDate) {
	...
	public CPMM1(Long cpmmId, String cpmmChseCd, Long cmmId,
			String cmmChaseCode, Long rawChseId, Long cpmgId, String cmpgCd,
			Long memId, Long addrId, String addrZipCd, Long provId,
			Integer msrVer, Long measureId, String msrCd, Long submsrId,
			String submsrCd, Long healthPlanId, String healthPlanCd,
			Long lobId, String lobCd, Long prodId, String productCode,
			Long mocDtlId, Date denominatorQualifyingEventDate,
			String assgdToUser, Date chseDueDt, Long cpmmChaseStatusMasterId,
			String cpmmChseStsCd, String cpChaseCode, Long overrideCount,
			Date validFromDate, Date validToDate, Boolean deleted,
			String action, String loginUser, String previousActivity,
			Long subProcessInstanceId, String owner) {
		super();
		this.cpmmId = cpmmId;
		this.cpmmChseCd = cpmmChseCd;
		this.cmmId = cmmId;
	...
	public CPMM1(java.lang.Long cpmmId, java.lang.String cpmmChseCd,
			java.lang.Long cmmId, java.lang.String cmmChaseCode,
			java.lang.Long rawChseId, java.lang.Long cpmgId,
			java.lang.String cmpgCd, java.lang.Long memId,
			java.lang.Long addrId, java.lang.String addrZipCd,
			java.lang.Long provId, java.lang.Integer msrVer,
			java.lang.Long measureId, java.lang.String msrCd,
			java.lang.Long submsrId, java.lang.String submsrCd,
			java.lang.Long healthPlanId, java.lang.String healthPlanCd,
			java.lang.Long lobId, java.lang.String lobCd,
			java.lang.Long prodId, java.lang.String productCode,
			java.lang.Long mocDtlId,
			java.util.Date denominatorQualifyingEventDate,
			java.lang.String assgdToUser,
			java.lang.Long cpmmChaseStatusMasterId,
			java.lang.String cpmmChseStsCd, java.lang.String cpChaseCode,
			java.lang.Long overrideCount, java.util.Date validFromDate,
			java.util.Date validToDate, java.lang.Boolean deleted,
			java.lang.String action, java.lang.String loginUser,
			java.lang.String previousActivity,
			java.lang.Long subProcessInstanceId, java.lang.String owner,
			java.util.Date chseDueDt, java.lang.String parentProcessID) {
		this.cpmmId = cpmmId;
		this.cpmmChseCd = cpmmChseCd;
		this.cmmId = cmmId;
		this.cmmChaseCode = cmmChaseCode;
